...
var XSD__DOUBLE = 'http://www.w3.org/2001/XMLSchema#double',
    XSD__INTEGER = 'http://www.w3.org/2001/XMLSchema#integer',
    XSD__DATE = 'http://www.w3.org/2001/XMLSchema#date',
    XSD__TIME = 'http://www.w3.org/2001/XMLSchema#time',
    XSD__DATE_TIME = 'http://www.w3.org/2001/XMLSchema#dateTime',
    XSD__G_YEAR_MONTH = 'http://www.w3.org/2001/XMLSchema#gYearMonth',
    XSD__G_YEAR = 'http://www.w3.org/2001/XMLSchema#gYear',
    XSD__DURATION = 'http://www.w3.org/2001/XMLSchema#duration';

function splitUnique(string) {
  return unique(string.trim().split(/\s+/));
}

function hasAttrib(node, attribute) {
  return !!node.attribs && DOM.hasAttrib(node, attribute);
}
...
module.exports = function (dom, base) {
  ...
  function isItem(element) {
    return hasAttrib(element, 'itemscope');
  }

  function isProperty(element) {
    return hasAttrib(element, 'itemprop');
  }

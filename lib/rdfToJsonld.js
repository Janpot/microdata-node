...
var RDF__NIL = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#nil';
var RDF__FIRST = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#first';
var RDF__REST = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#rest';
var RDF__LIST = 'http://www.w3.org/1999/02/22-rdf-syntax-ns#List';

var XSD__DOUBLE = 'http://www.w3.org/2001/XMLSchema#double',
    XSD__INTEGER = 'http://www.w3.org/2001/XMLSchema#integer',
    XSD__BOOLEAN = 'http://www.w3.org/2001/XMLSchema#boolean',
    XSD__STRING = 'http://www.w3.org/2001/XMLSchema#string';
...
function rdfToJsonld(triples, config) {
  config = config || {};
  var useRdfType =
    config.useRdfType === undefined ? false : config.useRdfType;
  var useNativeTypes =
    config.useNativeTypes === undefined ? true : config.useNativeTypes;
